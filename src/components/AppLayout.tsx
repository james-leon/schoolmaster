...
export function AppLayout({ title, children }: { title: string; children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (user.role === "parent" && pathname !== "/notifications" && pathname !== "/mon-profil" && pathname !== "/changer-mot-de-passe" && pathname !== "/calendrier") {
    ...
    // Authenticated-but-role-agnostic self pages (every signed-in user can reach them)
    const PUBLIC_PATHS = ["/login", "/register", "/forgot-password", "/confidentialite", "/cgu", "/unauthorized", "/changer-mot-de-passe", "/mon-profil", "/notifications"];
